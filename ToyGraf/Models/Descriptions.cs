namespace ToyGraf.Models
{
    public static class Descriptions
    {
        public const string
            ...
            CameraPosition = "The camera position for the scene.",
            CameraRotation = "The camera rotation for the scene (in degrees).",
            CameraView = "The camera view matrix for the scene.",
            ColourFormat = "The number of bits per pixel in each colour channel.",
            Depth = "The number of bits in the depth buffer.",
            Description = "A description for this trace.",
            FarPlane = "The distance from the camera position to the far plane of the frustrum.",
            FieldOfView = "The frustrum field of view (Y component, degrees).",
...
Vendor-specific information may follow the version number. Its format depends on the implementation, but a space always separates the version number and the vendor-specific information.",
            ...
            Location = "The location of the trace in world co-ordinates.",
            Maximum = "The upper limit along each domain or range axis.",
            Minimum = "The lower limit along each domain or range axis.",
            NearPlane = "The distance from the camera position to the near plane of the frustrum.",
            Orientation = "The orientation of the trace in world co-ordinates (in degrees).",
            Pattern = "The pattern applied to the sequence, grid or lattice of computed points.",
            Projection = "The projection matrix for the scene.",
            SampleCount = "The number of Full Screen Anti-Aliasing (FSAA) samples used.",
            Scale = "The relative size of the trace.",
