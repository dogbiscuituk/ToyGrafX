...
knowledge of several vertices at a time.")]
        ...
        {
            get => _ShaderVertex;
            set => Run(new TraceShaderVertexCommand(Index, value));
        }

        [Category("Shaders")]
        [Description(@"The tessellation control processor is a programmable unit that operates on a patch of incoming vertices
...
different values to the same per-patch output in a single phase.")]
        ...
        public string[] ShaderTessellationControl
        {
            get => _ShaderTessellationControl;
            set => Run(new TraceShaderTessellationControlCommand(Index, value));
        }

        [Category("Shaders")]
        [Description(@"The tessellation evaluation processor is a programmable unit that evaluates the position and other
...
primitive being tessellated. The executable writes the position and other attributes of the vertex.")]
        ...
        public string[] ShaderTessellationEvaluation
        {
            get => _ShaderTessellationEvaluation;
            set => Run(new TraceShaderTessellationEvaluationCommand(Index, value));
        }

        [Category("Shaders")]
        [Description(@"The geometry processor is a programmable unit that operates on data for incoming vertices for a primitive
...
subsequent pipeline stages.")]
        ...
        {
            get => _ShaderGeometry;
            set => Run(new TraceShaderGeometryCommand(Index, value));
        }

        [Category("Shaders")]
        [Description(@"The fragment processor is a programmable unit that operates on fragment values and their associated
...
fragments to be generated.")]
        ...
        {
            get => _ShaderFragment;
            set => Run(new TraceShaderFragmentCommand(Index, value));
        }

        [Category("Shaders")]
        [Description(@"The compute processor is a programmable unit that operates independently from the other shader
...
memory and control barriers to synchronize with other members of the same work group.")]
        ...
        {
            get => _ShaderCompute;
            set => Run(new TraceShaderComputeCommand(Index, value));
        }
        ...
        internal string[]
            _ShaderVertex,
            _ShaderTessellationControl,
            _ShaderTessellationEvaluation,
            _ShaderGeometry,
            _ShaderFragment,
            _ShaderCompute;
