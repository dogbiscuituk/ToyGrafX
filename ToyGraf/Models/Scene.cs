namespace ToyGraf.Models
{
    ...
    public class Scene
    {
        ...
        [Description("The full source code of the GPU program.")]
        [DisplayName("GPU Code")]
        ...
        [Description("The list of diagnostic, warning and error messages generated by the most recent GPU program compilation.")]
        [DisplayName("GPU Log")]
        [Editor(typeof(MultilineStringEditor), typeof(UITypeEditor))]
        [JsonIgnore]
        ...
        [Description("The status of the most recent GPU program compilation.")]
