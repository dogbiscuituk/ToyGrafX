namespace ToyGraf.Commands
{
    ...
    {
        internal FarPlaneCommand(float value) : base(DisplayNames.FarPlane,
    ...
    {
        internal FieldOfViewCommand(float value) : base(DisplayNames.FieldOfView,
    ...
    {
        internal NearPlaneCommand(float value) : base(DisplayNames.NearPlane,
